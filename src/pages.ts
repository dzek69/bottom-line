...
const pages = (totalPages: number, display = DEFAULT_DISPLAY, current = 1): PagesResult => {
    ...
    let first: number | null = 1,
        last: number | null = totalPages,

        left: string | null = "..",
        right: string | null = "..";

    const list: PagesResult["list"] = [];
